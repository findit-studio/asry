...
[<img alt="Build" src="https://img.shields.io/github/actions/workflow/status/findit-studio/asry/ci.yml?logo=GitHub-Actions&style=for-the-badge" height="22">][CI-url]
[<img alt="codecov" src="https://img.shields.io/codecov/c/gh/findit-studio/asry?style=for-the-badge&token=6R3QFWRWHL&logo=codecov" height="22">][codecov-url]
...
| `bench-internals` | no | Re-exports `pub(crate)` alignment internals (scalar/SIMD normaliser variants, the trellis/beam DP — `get_trellis`, `backtrack_beam`, `align_to_word_segments` — and `LogProbsTV`) under `asry::__bench` so the SIMD baseline bench can call them directly. Doc-hidden; never enable in shipping builds. Implies `alignment`. |
...
[`findit-studio/audio-fixtures`][audio-fixtures-url] so they don't
...
[GitHub-url]: https://github.com/findit-studio/asry
[CI-url]: https://github.com/findit-studio/asry/actions/workflows/ci.yml
[codecov-url]: https://app.codecov.io/gh/findit-studio/asry/
[doc-url]: https://docs.rs/asry
[crates-url]: https://crates.io/crates/asry
[whisperx-url]: https://github.com/m-bain/whisperX
[audio-fixtures-url]: https://github.com/findit-studio/audio-fixtures
